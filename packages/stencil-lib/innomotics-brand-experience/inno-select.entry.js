...
import { c as computePosition, s as shift, f as flip, a as autoUpdate } from './floating-ui.dom.esm-f11f0749.js';
...
const InnoSelect = class {
    ...
    render() {
        ...
        return (h(Host, { key: '375736989a5b2b8c948793440ff4f856f6b73657', tabindex: 0, class: {
                ...
                dark: this.variant === 'dark',
                primary: this.variant === 'primary'
            }, innerHTML: sanitizeHtml_1(this.label), ref: el => this.floatingLabel = el }), h("span", { class: {
                'label-value': true,
                disabled: this.disabled,
                'disabled-light': this.disabled && this.variant === 'primary' && this.disabledBackgroundColor === 'light',
                'disabled-dark': this.disabled && this.variant === 'primary' && this.disabledBackgroundColor === 'dark',
...
InnoSelect.style = innoSelectCss;

export { InnoSelect as inno_select };

//# sourceMappingURL=inno-select.entry.js.map