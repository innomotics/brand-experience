...
import { d as defineCustomElement$1 } from './p-d4b96023.js';
...
const InnoButton = /*@__PURE__*/ proxyCustomElement(class InnoButton extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return InnoButtonStyle0; }
}, [6, "inno-button", {
        "variant": [1025],
        "colorVariant": [1025, "color-variant"],
        "type": [1],
        "tabIdx": [1026, "tab-idx"],
        "disabled": [1540],
        "icon": [1025],
        ...
        "navDirection": [1025, "nav-direction"],
        "iconOnly": [4, "icon-only"],
        "listType": [516, "list-type"]
    }]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["inno-button", "inno-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "inno-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InnoButton);
            }
            break;
        case "inno-icon":
            if (!customElements.get(tagName)) {
...
export { InnoButton as I, defineCustomElement as d };

//# sourceMappingURL=p-6b4a62d6.js.map