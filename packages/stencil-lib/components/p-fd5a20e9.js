...
const InnoStatusMessage = /*@__PURE__*/ proxyCustomElement(class InnoStatusMessage extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return InnoStatusMessageStyle0; }
}, [6, "inno-status-message", {
        "theme": [1],
...
function defineCustomElement() {
    ...
    const components = ["inno-status-message", "inno-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "inno-status-message":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InnoStatusMessage);
            }
            break;
        case "inno-icon":
            if (!customElements.get(tagName)) {
...
export { InnoStatusMessage as I, defineCustomElement as d };

//# sourceMappingURL=p-fd5a20e9.js.map