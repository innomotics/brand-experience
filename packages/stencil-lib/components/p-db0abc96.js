...
import { c as computePosition, o as offset, s as shift, f as flip, b as arrow, a as autoUpdate } from './p-ae69ea43.js';
...
const InnoPopover = /*@__PURE__*/ proxyCustomElement(class InnoPopover extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return InnoPopoverStyle0; }
}, [6, "inno-popover", {
        "trigger": [1],
        "variant": [1025],
        "for": [1],
        "popoverTitle": [1025, "popover-title"],
        "popoverText": [1025, "popover-text"],
        "placement": [1025],
        "offset": [1026],
        "visible": [1028],
        "hasBackdrop": [1028, "has-backdrop"],
        "closable": [1028],
        "animationFrame": [4, "animation-frame"],
        "showTooltip": [64],
        "hideTooltip": [64],
        "updateForElement": [64]
    }, [[8, "keydown", "onKeydown"], [8, "click", "onClick"]], {
        "visible": ["visibleChanged"]
    }]);
function defineCustomElement() {
    ...
    const components = ["inno-popover", "inno-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "inno-popover":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InnoPopover);
            }
            break;
        case "inno-icon":
            if (!customElements.get(tagName)) {
...
export { InnoPopover as I, defineCustomElement as d };

//# sourceMappingURL=p-db0abc96.js.map