...
export const getButtonClasses = (
  ...
  return {
    btn: true,
    'btn-primary': isPrimary(variant) && !outline,
    'btn-outline-primary': isPrimary(variant) && outline,
    'btn-invisible-primary': isPrimary(variant) && !outline,
    'btn-secondary': isSecondary(variant) && !outline,
    'btn-outline-secondary': isSecondary(variant) && outline,
    'btn-invisible-secondary': isSecondary(variant) && !outline,
    'btn-icon': iconOnly,
    'btn-oval': iconOval,
    selected: selected,
    disabled: disabled
