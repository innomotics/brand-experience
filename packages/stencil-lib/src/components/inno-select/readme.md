...
| ------------------------ | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ------------------------------- |
| `disableLabelAutoResize` | `disable-label-auto-resize` | By default the InnoSelect component automatically resizes the labels so they will fit inside. You can turn this behavior off e.g. if you are sure the labels will always fit.                                                                                                         | `boolean`           | `false`                         |
